...
def MouseDoubleClick(x = None,y = None):
    if not x is None and not y is None:
        MouseMove(x,y)
        time.sleep(0.05)
    win32api.mouse_event(win32con.MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0)
...
def EachRowMouseLoop(x,y,count):
...
x = 195.0
y = 225.0
EachRowMouseLoop(x,y,21)
# Strength-2
y += y_axis_add_1
EachRowMouseLoop(x,y,16)
# Agility-1
y += y_axis_add_2
EachRowMouseLoop(x,y,21)
# Agility-2
